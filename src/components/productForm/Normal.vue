				...
				<b-form @submit.prevent="addProduct" enctype="multipart/form-data">
					<div class="row">
						...
						<div class="col-md-9 personal-info">
							...
							<div v-if="typeinfo.download" class="form-group">
								<label class="col-lg-3 control-label">Data produk :</label>
								<div class="col-lg-8">
									<b-form-file v-validate="'required'" v-model="productData" ref="file-input" name="location" class="mb-2"></b-form-file>
							...
							<div v-else class="form-group">
								...
								<div class="col-lg-8">
									<input class="form-control" v-validate="'required|url'" v-model="location" placeholder="Alamat produk" name="location" type="text" value="" autofocus />
									<small v-if="errors.has('location')" id="locationHelp" class="form-text text-danger">{{ errors.first('location') }}</small>
								</div>
							</div>
						</div>
					...
					<input type="file" hidden multiple accept="image/*" ref="mediaFile" @change="onMediaChange" />
